...
export default function EditEventPage() {
            ...
            try {
                ...
                if (eventRes.ok) {
                    ...
                    setFormData({
                        ...
                        startDate: toLocalDateTimeInput(eventData.startDate),
                        endDate: toLocalDateTimeInput(eventData.endDate),
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Convert datetime-local (no timezone) to proper ISO strings
            ...
            // Navigate to event detail and refresh server components to show updated data
